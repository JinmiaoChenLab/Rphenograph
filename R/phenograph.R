...
#' @param prune logical; determines whether symmetric matrix is generated by average (FALSE) or multiplication (TRUE) with the transpose (defaults:FALSE)
#'
...
#' 
#' @export
Rphenograph <- function(data, k=30, directed=FALSE, prune=FALSE){
    if(prune){
